...
## 1. Load packages that are need to conduct this analysis (NB. All the packages are already installed from prior works):
...
## 2. Download, clean, and process data (Landsat 8 collective 2 level 1)
...
## 3. Visualize data and display plots
...
## 4. Analysis (establishing patterns from the data-hotspot analysis using the mean_temperature)
