...
```
```{r}
ndvi_flat <- as.numeric(values(ndvi))
ndbi_flat <- as.numeric(values(ndbi))
lst_flat <- as.numeric(values(lst))
...
corr_plot<-corrplot(correlation_matrix, method = "color", col = colorRampPalette(c("blue", "white", "red"))(200), 
         tl.col = "black", tl.srt = 45, addCoef.col = "black", number.cex = 0.7, cl.cex = 0.7, 
         main = "Correlation Matrix of NDVI, NDBI, and LST")
#Display
corr_plot
```
